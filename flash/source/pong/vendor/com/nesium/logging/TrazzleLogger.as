package com.nesium.logging {
	...
	public class TrazzleLogger extends EventDispatcher
	{
		...
		***************************************************************************/
		...
		public function log(msg:String, stackIndex:int = 1):void
		{
			send(msg, stackIndex);
		}
		...
		*							private methods								   *
		***************************************************************************/
		private function send(message:String, stackIndex:int):void
		{
			var stacktrace:StackTrace = new StackTrace();
			var logMessage:LogMessageVO = new LogMessageVO(message, stacktrace, stackIndex + 5);
